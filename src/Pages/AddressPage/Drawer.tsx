...
import { CloseOutlined, HomeOutlined, PlusOutlined, UploadOutlined } from '@ant-design/icons';
...
const AddressDrawer: React.FC = ({open,setOpen}:any) => {
  ...
  return (
    <>
      <Drawer
        ...
        extra={
          <Space>
           <p className=' text-sm text-blue-400 cursor-pointer' onClick={toggleAddModal}>Add New Address</p>
          </Space>
        }
      >
 ...
 <div className='flex gap-2 justify-end'>
        ...
        <Button type='primary' icon={<UploadOutlined />}>Save</Button>
        </div>

        </div>:<div className='flex justify-center items-center min-h-svh'>
  <span className=' text-red-500'>Please Create your address in order to deliver your order</span></div>}
